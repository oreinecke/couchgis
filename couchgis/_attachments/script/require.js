...
// syntax. Calls to require within libraries are evaluated and relative paths
// are supported. Critical variables have been shadowed but the library would
// still be able to manipulate other globals i.e. window, document, $ etc.
